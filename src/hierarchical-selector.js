...
(function(){
  ...
  .directive('hierarchicalSelector', hierarchicalSelector);

  hierarchicalSelector.$inject = ['$compile', 'selectorUtils'];

  function hierarchicalSelector($compile, selectorUtils){
    return {
      restrict: 'E',
      replace: true,
...
(function(){
  ...
  angular.module('hierarchical-selector.selectorUtils', []).factory('selectorUtils', selectorUtils);

  selectorUtils.$inject = ['$q'];

  function selectorUtils($q){
    return {
...
(function(){
  ...
  angular.module('hierarchical-selector.tree-item', ['hierarchical-selector.selectorUtils']).directive('treeItem', treeItem);

  treeItem.$inject = ['$compile', '$q', 'selectorUtils'];
  function treeItem($compile, $q, selectorUtils){
    return {
      restrict: 'E',
      replace: true,
